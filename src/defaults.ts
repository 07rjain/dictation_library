...
export const DEFAULT_DICTATION_MAX_DELETION_RATIO = 0.25;
export const DEFAULT_DICTATION_MAX_EXPANSION_RATIO = 1.35;
export const DEFAULT_VERBATIM_MAX_DELETION_RATIO = 0.08;
export const DEFAULT_VERBATIM_MAX_EXPANSION_RATIO = 1.15;
...
export const DEFAULT_LIVE_WINDOW_OVERLAP_MS = 500;
export const DEFAULT_LIVE_MAX_PENDING_WINDOWS = 4;
export const DEFAULT_LIVE_MAX_PENDING_BYTES = 32 * 1024 * 1024;
export const DEFAULT_LIVE_CLEANUP_WINDOW_CHARS = 12_000;
